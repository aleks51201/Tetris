...
public class FieldFirstMode : MonoBehaviour, ICreatable, ISwitchTetromino
{
    ...
    private void PatrolDetector(Vector2 detectorStartPosition)
    {
        Vector2 newPosition;
        int numLine = 0;
    ...
    {
        return (detectedObject.Length >= widthField * 2);
    }
    ...
    {
        PatrolDetector(this.detectorStartPosition);
        ScoreUpdate();
    }
